...
#Block 1
	...
	#Processes count and Launch Time calculation
	adb shell monkey -p com.gameloft.android.ANMP.GloftPDHM -c android.intent.category.LAUNCHER 1
	sleep 2
...
#Block 5
	...
	#Processes count and Launch Time calculation
	adb shell monkey -p com.rovio.angrybirds -c android.intent.category.LAUNCHER 1
	sleep 2
