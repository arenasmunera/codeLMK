...
#Block 11
	#Processes count and Launch Time calculation
	adb shell monkey -p com.devuni.flashlight -c android.intent.category.LAUNCHER 1
	sleep 2
...
#Block 12
	...
	#Processes count and Launch Time calculation
	adb shell monkey -p com.google.android.calendar -c android.intent.category.LAUNCHER 1
	sleep 2
